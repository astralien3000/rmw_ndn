...
set(_output_path
  "${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_cbor_cpp/${PROJECT_NAME}")
...
foreach(_idl_file ${rosidl_generate_interfaces_IDL_FILES})
  ...
  if(_parent_folder STREQUAL "msg")
    list(APPEND _generated_msg_header_files
      "${_output_path}/${_parent_folder}/${_header_name}__rosidl_typesupport_cbor_cpp.hpp"
    )
...
set(target_dependencies
  "${rosidl_typesupport_cbor_cpp_BIN}"
  ${rosidl_typesupport_cbor_cpp_GENERATOR_FILES}
  "${rosidl_typesupport_cbor_cpp_TEMPLATE_DIR}/msg__rosidl_typesupport_cbor_cpp.hpp.em"
  "${rosidl_typesupport_cbor_cpp_TEMPLATE_DIR}/msg__type_support.cpp.em"
  "${rosidl_typesupport_cbor_cpp_TEMPLATE_DIR}/srv__rosidl_typesupport_cbor_cpp.hpp.em"
  "${rosidl_typesupport_cbor_cpp_TEMPLATE_DIR}/srv__type_support.cpp.em"
...
set(generator_arguments_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_cbor_cpp__arguments.json")
rosidl_write_generator_arguments(
  ...
  TEMPLATE_DIR "${rosidl_typesupport_cbor_cpp_TEMPLATE_DIR}"
...
add_custom_command(
  ...
  COMMAND ${PYTHON_EXECUTABLE} ${rosidl_typesupport_cbor_cpp_BIN}
...
set(_target_suffix "__rosidl_typesupport_cbor_cpp")

add_library(${rosidl_generate_interfaces_TARGET}${_target_suffix} ${rosidl_typesupport_cbor_cpp_LIBRARY_TYPE}
...
if(BUILD_TESTING AND rosidl_generate_interfaces_ADD_LINTER_TESTS)
  if(NOT _generated_msg_header_files STREQUAL "" OR NOT _generated_srv_header_files STREQUAL "")
    ...
    ament_cppcheck(
      TESTNAME "cppcheck_rosidl_typesupport_cbor_cpp"
      "${_output_path}")

    find_package(ament_cmake_cpplint REQUIRED)
    get_filename_component(_cpplint_root "${_output_path}" DIRECTORY)
    ament_cpplint(
      TESTNAME "cpplint_rosidl_typesupport_cbor_cpp"
    ...
    ament_uncrustify(
      TESTNAME "uncrustify_rosidl_typesupport_cbor_cpp"
      # the generated code might contain longer lines for templated types
      MAX_LINE_LENGTH 999
      "${_output_path}")
  endif()
