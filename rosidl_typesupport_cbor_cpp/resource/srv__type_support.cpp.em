// generated from rosidl_typesupport_cbor_cpp/resource/srv__type_support.cpp.em
...
#include "rosidl_typesupport_cbor_cpp/service_introspection.hpp"
#include "rosidl_typesupport_cbor_cpp/service_type_support_decl.hpp"
...
static ::rosidl_typesupport_cbor_cpp::ServiceMembers @(spec.srv_name)_service_members = {
...
get_service_type_support_handle<@(spec.pkg_name)::srv::@(spec.srv_name)>()
{
  ...
  auto service_type_support =
    &::@(spec.pkg_name)::srv::rosidl_typesupport_cbor_cpp::@(spec.srv_name)_service_type_support_handle;
  // get a non-const and properly typed version of the data void *
  auto service_members = const_cast<::rosidl_typesupport_cbor_cpp::ServiceMembers *>(
    static_cast<const ::rosidl_typesupport_cbor_cpp::ServiceMembers *>(
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      const ::rosidl_typesupport_cbor_cpp::MessageMembers *
      >(
      ::rosidl_typesupport_cbor_cpp::get_message_type_support_handle<
